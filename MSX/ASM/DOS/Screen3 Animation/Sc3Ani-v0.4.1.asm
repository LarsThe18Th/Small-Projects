...
; -  Loading Message
	...
	code @ 100h
				...
				jr begin
nametag:
				db 10,13,"Sc3Ani 0.4.1",10,13,10,13
				db "By Lars The 18Th - "
				db "CINICSYSTEMS.TK (c) 2018",10,13,"$"
...
writedone:
				...
				ld hl,frameorder					;Select what frame to show
...
whait:
				...
				jr c,noframe
					ld a,b
					cp 11							;Check if this is the last frame
					jr nz,reset
